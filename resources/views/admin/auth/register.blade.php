...
<head>
    ...
    <title>{{ $_system_config->site_name }}-注册</title>
...
<div class="login-box">
    <div class="login-logo">
        <a href="#"><b>{{ $_system_config->site_name }}<br>管理后台</b></a>
    </div><!-- /.login-logo -->
    <div class="login-box-body">
        ...
        <form action="{{ route('admin.register.post') }}" method="post">
            ...
            <div class="form-group has-feedback">
                <input type="name" class="form-control" name="name" placeholder="Name" required title="请输入账号" value="{{ old('name') }}"/>
            ...
            <div class="form-group has-feedback">
                <input type="password_confirmation" class="form-control" name="password_confirmation" placeholder="PasswordConfirmation" required title="请输入确认密码"/>
                <span class="glyphicon glyphicon-lock form-control-feedback"></span>
            </div>
            <div class="row">
                <div class="col-xs-8">
