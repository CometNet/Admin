    ...
    <section class="content">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <form class="form-horizontal cmxform" name="registerForm" id="form" action="{{ route('channel.update', ['id' => $data->getKey()]) }}" method="post">
                    {!! csrf_field() !!}
                    ...
                    <div class="box-footer">
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                ...
                                &nbsp;<a href="{{ route('channel.index') }}" class="btn btn-info">返回</a>
                            </div>
                        </div>
                    </div>
                </form>
